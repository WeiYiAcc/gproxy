...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_10341: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_10402: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_13513: (a: number, b: number, c: number) => void;
